                ...
                <nav id="navigation" className={windowWidth > 991 ? "navigation navigation-landscape" : "navigation navigation-portrait"}>
                                ...
                                <li>
                                    <div className="btn-group account-drop">
                                        ...
                                        <div className="dropdown-menu pull-right animated flipInX" id="showings" style={{display:userMenu ? 'block' : 'none'}}>
                                            <Link href="/dashboard"><i className="fa-solid fa-gauge"></i>Dashboard</Link>
											<Link href="/my-profile"><i className="fa-solid fa-address-card"></i>My Profile</Link>                                  
											<Link href="/my-property"><i className="fa-solid fa-building-circle-check"></i>My Property</Link>                                   
											<Link href="/bookmark-list"><i className="fa-solid fa-bookmark"></i>Bookmarked Property</Link>                                   
											<Link href="/submit-property-dashboard"><i className="fa-solid fa-house"></i>Submit Property</Link>                                   
											<Link href="/change-password"><i className="fa-solid fa-unlock"></i>Change Password</Link>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                    ...
                    <div className={`nav-menus-wrapper  ${toggle ? 'nav-menus-wrapper-open' : ''}`} style={{transitionProperty:toggle ? 'none' : 'left'}}>
                        ...
                        <ul className="nav-menu">
                            ...
                            <li className={`${['/blog','/blog-detail','/component','/pricing','/404','/contact'].includes(current)?'active':''} ${activeMenu['pages']?.main ? 'show' : ''}`} onMouseEnter={() => handleMouseEnter('pages')} onMouseLeave={() => handleMouseLeave('pages')}><Link href="#">Pages<FiChevronDown className="submenu-indicator"/></Link>
								...
								<li>
									<div className="btn-group account-drop">
										<button type="button" className="btn btn-order-by-filt dropdown-toggle" onClick={()=>setUserMenu(!userMenu)}>
											<img src='/img/team-1.jpg' className="avater-img" alt=""/>Hi, Admin
										</button>
