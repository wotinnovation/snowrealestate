...
import PropertySidebarTwo from './property-sidebar-two'
import ListPropertyFour from './list-property-four'
    ...
    <>
        ...
        <div className="row">
            <div className="col-lg-4 col-md-12 col-sm-12">
                <PropertySidebarTwo show={show} setShow={setShow}/>
            </div>
                        ...
                        <div className="item-shorting-box">
                            ...
                            <div className="item-shorting-box-right">
                                ...
                                <ul className="shorting-list">
                                    <li>
                                        <Link href="/grid-layout-with-sidebar" className="w-12 h-12">
                                    ...
                                    <li>
                                        <Link href="/listings-list-with-sidebar" className="active w-12 h-12">
