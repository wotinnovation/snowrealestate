            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-12 col-md-12">
                        ...
                        <span className="ipn-subtitle">Modern house</span>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div className="col-lg-12 col-md-12">
                        <div className="agency agency-list overlio-40">
                            <div className="agency-avatar">
                                <Image src='/img/ag-1.png' width={0} height={0} sizes='100vw' style={{width:'100%', height:'auto'}} alt=""/>
                            </div>
                            <div className="agency-content">
                                <div className="agency-name">
                                    <h4><Link href="/agency-page">Strive Partners Realty</Link></h4>
